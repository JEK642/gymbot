...
async function statsCommand(ctx) {
    ...
    try {
        ...
        const [latestWeightLog, weeklyWorkouts, totalWorkouts, weightProgress] = await Promise.all([
            ...
            (0, workoutService_1.getWorkoutsThisWeek)(telegramId),
            (0, workoutService_1.getTotalWorkouts)(telegramId),
            (0, weightService_1.getWeightProgress)(telegramId), // BARU: progress tracking
        ]);
        // ==========================================
        ...
        await ctx.reply(`📊 *Statistik ${firstName}*\n` +
            `━━━━━━━━━━━━━━━━━━\n\n` +
            `${weightDisplay}\n` +
            `${progressLine}\n` +
            `${weightMotivation}\n\n` +
